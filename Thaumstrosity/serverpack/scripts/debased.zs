...
Research.orphanResearch("TB.SpawnerCompass");
Research.orphanResearch("TB.SINSTONE");
...
Research.removeResearch("TB.SpawnerCompass");
Research.removeResearch("TB.SINSTONE");
...
game.setLocalization("en_US", "tc.research_text.TB.Revolver.Primal", "What lies beyond lightspeed...");
game.setLocalization("en_US", "tc.research_name.TB.Revolver.Atropods", "Revolver Upgrade: Bane Of Arthopods");
...
game.setLocalization("en_US", "tb.rec.enchantments.page.1", "Weapons, enchanted with Elder Wisdom will have a chance to provide the thaumaturge using them with some knowledge of object they slay.");
game.setLocalization("en_US", "tb.rec.enchantments.page.3", "Weapons, enchanted with Magic Touched will provide thaumaturge using them with more primal aspects from enemies they kill.");
game.setLocalization("en_US", "tb.rec.enchantments.page.4", "Weapons, enchanted with Vaporising enchantment will have a chance to provide the thaumaturge using them with some crystallized life essentia of creatures they slay.");
game.setLocalization("en_US", "tb.rec.campfire.page.0", "If a person wanders around in the forest when it is getting dark and is too far away from home to go to their bed, they are probably stuck there in the darkness with monsters all around. However, you are a thaumaturge, surely you can solve that minor problem! You have discovered a way to make a magical campfire! To light it up you first need to put a log into it - magical logs may be more long-lasting. Next just insert any fuel in it. Your campfire is made with magic, so monsters around it will get scared and run away, just as creepers run away from cats! However, sometimes a hunger will make the monster ignore the campfire to a certain extend - it is not 100% safe.");
...
game.setLocalization("en_US", "tb.rec.tobacco.page.1", "To properly rest a thaumaturge like you needs 3 things - a nice house - which you should have already - their smoking pipe and some tobacco. To properly make the tobacco a thaumaturge must grind the leaves of a plant. You might need a Pestle and Mortar to do so. You will also need your smoking pipe, but you do not want those mundane pipes, do you? You have discovered a way to properly infuse some Greatwood planks to make a perfect pipe. It is also good for your magic contact, since it has a Salis Mundus as one of it's components.");
game.setLocalization("en_US", "tb.rec.etobacco.page.0", "You have discovered a way to infuse regular tobacco powder with some eldritch energy. The result may not be that safe to smoke, however, should a thaumaturge smoke such a thing their vision will go grim for some time. One with such vision should not look at living beings. It is also possible to attract the attention of the 'eldritch' by doing so, however the chances are low. The tobacco might cause sanity problems!");
game.setLocalization("en_US", "tb.rec.witobacco.page", "You have gone beyond the relaxing properties of the tobacco. Infusing your tobacco with knowledge sure was a great idea - you have managed to create a tobacco, which puts you in a crystal clear mind state once you smoke it. The effect lasts a mere second, though it is more than enough to make a shocking discovery or two. However, you are afraid that you may also see something horrible there, which will corrupt your mind... Well, one who does not risk - does not get their reward, right?");
game.setLocalization("en_US", "tb.rec.ttobacco.page.0", "You are not quite sure why you have even discovered this. Sure, now you can infuse your tobacco with taint, forever changing it, so that anyone who smokes it will have their mind corrupted by taint, and all the horrors of the dark will appear in their mind, but what is it even useful for? The taint pieces also leave tiny signs on the pipe of the smoker. You are interested in the ways this will affect things like silverwood... Probably nothing good though.");
game.setLocalization("en_US", "tb.rec.spikeIron.page.0", "Sometimes a thaumaturge just wants to study their research. Calm, alone and without any zombies at their back. Sure, sometimes a door might just be enough. Sometimes, however, a thaumaturge may want those fools to suffer. It's a shame thaumaturgy does not offer a way of passivly killing enemies... Or does it? You have managed to create spikes that will damage everyone who steps on them. However they also tears apart items dropped by fools. There might be a way to resolve this problem... A thaumaturge may also notice that after killing a creature the spikes get covered in blood. To wipe the blood out you need to use your Enchanted Fabric on the spikes. The fabric will get covered in blood, but it can be cleared in a crucible.");
game.setLocalization("en_US", "tb.rec.drainFoci.page.0", "Sometimes a Thaumaturge wants to live under the sea, §m next to their pineapple §r in their beautifull water dome. However, building underwater is a huge pain... Until now. This wand foci will resolve the problem! It will destroy blocks of water the thaumaturge is looking at, without making all nearby water blocks flow! In other ways, it is perfect in creating tunnels! However, magic can only harness the water so long, and the water will eventually return to it's normal flowing state. It will also do so should a block be placed next to the not-flowing water block.");
game.setLocalization("en_US", "tb.rec.expFoci.page.0", "The only ways of enchanting for a regular thaumaturge is either by using their own mind essence to roll the dice or by using the infusion matrix to control the process. Either way some mind essence is required. The most efficent way of collecting it is by... killing mobs? Mining? You think, that thaumaturgy must offer something else, more 'magical'. And this is it. This foci will instantly break the block it is used on, providing a thaumaturge with twice the experience the block would usually drop! Blocks, which usually do not provide experience will drop some based on the Potency level of the foci.");
/*game.setLocalization("en_US", "tc.research_text.TB.Tobacco.Eldritch", "Henderson's Smoke");
game.setLocalization("en_US", "tc.research_text.TB.Tobacco.Eldritch", "Henderson's Smoke");
game.setLocalization("en_US", "tc.research_text.TB.Tobacco.Eldritch", "Henderson's Smoke");
game.setLocalization("en_US", "tc.research_text.TB.Tobacco.Eldritch", "Henderson's Smoke");*/